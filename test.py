...
def main():
    st.write('**Программа предназначена для студентов 3-го курса ВМК. С помошью нее вы узнаете вероятность получения автомата по Оптимальному управлению в 5-м семестре. Модель была обучена на данных прошлых лет**')
